...
object MpegError {
  ...
  def joinErrors[S, I, O](t: Transform[S, I, Either[MpegError, O]]): Transform[S, Either[MpegError, I], Either[MpegError, O]] =
    t.semipass(_.fold(e => Left(Left(e)), i => Right(i)))

  def passErrors[S, I, O](t: Transform[S, I, O]): Transform[S, Either[MpegError, I], Either[MpegError, O]] =
    t.right
}
